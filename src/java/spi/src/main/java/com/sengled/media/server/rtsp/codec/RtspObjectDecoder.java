 ...
 * @date 2016年4月15日
 */
public class RtspObjectDecoder extends ByteToMessageDecoder {

    public static final String NAME = "RtspObjectDecoder";
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        while (in.readableBytes() >= remains) {
            ...
            case READ_RTP_LENGTH:
                ...
                break;
            case READ_RTP:
                out.add(new InterleavedFrame((byte)rtpChannle, in.readSlice(rtpLength).copy()));
                ...
                if (ch2 == HttpConstants.LF) {
                    ...
                    if (seq.length() > 0) {
                        ...
                        if (contentLength > maxChunkSize) {
                            throw new IllegalArgumentException("content length is too large, maxChunkSize = " + maxChunkSize + ", real = " + contentLength);
                        }
