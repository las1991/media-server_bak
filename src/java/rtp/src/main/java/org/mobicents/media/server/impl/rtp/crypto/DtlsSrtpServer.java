...
public class DtlsSrtpServer extends DefaultTlsServer {
    ...
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(DtlsSrtpServer.class);
	...
	public void notifyAlertRaised(short alertLevel, short alertDescription, String message, Exception cause) {
        LOGGER.warn(String.format("DTLS server raised alert (AlertLevel.%d, AlertDescription.%d, message='%s')", alertLevel, alertDescription, message), cause);
    }

    public void notifyAlertReceived(short alertLevel, short alertDescription) {
    	LOGGER.warn(String.format("DTLS server received alert (AlertLevel.%d, AlertDescription.%d)", alertLevel, alertDescription));
    }
