...
public class RtpClock {
	...
	public static final Logger logger = LoggerFactory.getLogger(RtpClock.class);
    ...
    public long getLocalRtpTime() {
        return (long)(scale * wallClock.getTime(TimeUnit.MILLISECONDS) + drift);
    }
    ...
    public long convertToAbsoluteTime(long timestamp) {
        return (long)(timestamp * 1000 / clockRate);
    }
    ...
    public long convertToRtpTime(long time) {
    	return (long)(time * clockRate / 1000);
    }
